...
public class DeviceParameters {
	...
	public String[] GetPhoneSNList() {
		...
		String[] phoneSNsTmp = new String[Max];
		int SNCountTmp = 0;
	...
	public int[] GetPhoneLW(String SN) {
		...
		String strCommands;
		int[] XY = new int[2];
		String cmdStr = "adb -s " + this.SN + " shell getevent -p";
	...
	public int[] GetPhoneResolution(String SN) {
		...
		String strCommands;
		int[] XY = new int[2];
		String cmdStr = "adb -s " + this.SN + " shell wm size";
	...
	public int[] GetPhoneVersion(String SN) {
		...
		String strCommands;
		String cmdStr = "adb -s " + this.SN + " shell getprop ro.build.version.release";
