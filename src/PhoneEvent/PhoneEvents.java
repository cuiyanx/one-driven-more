...
public class PhoneEvents {
	...
	public void KeyPress(String keyWord) {
		...
		try {
			String cmdStr = "cmd /c adb -s " + this.SN + " shell input keyevent " + myKeyNumber;
	...
	public void ScreenTap(String keyXs, String keyYs) {
		...
		try {
			String cmdStr = "cmd /c adb -s " + this.SN + " shell input tap " + this.keyXs + " " + this.keyYs;
			Runtime.getRuntime().exec(cmdStr);
			System.out.println(this.SN + ":");
	...
	public void ScreenSwipe(String keyXs, String keyYs, String keyXe, String keyYe) {
		...
		try {
			String cmdStr = "cmd /c adb -s " + this.SN + " shell input swipe " + this.keyXs + " " + this.keyYs + " " + this.keyXe + " " + this.keyYe;
			Runtime.getRuntime().exec(cmdStr);
			System.out.println(this.SN + ":");
			System.out.println("Swipe: " + this.keyXs + "  " + this.keyYs);
			System.out.println("       " + this.keyXe + "  " + this.keyYe);
		} catch (Exception e) {
			System.out.print("---------error---------");
		}
	}
	...
	public void KeyPressUser(String keyWord) {
		...
		for (int i = 0; i < myKeyNum.length; i++) {
			String cmdStr = "cmd /c adb -s " + SN + " shell sendevent /dev/input/event2 " + myKeyNum[i];
